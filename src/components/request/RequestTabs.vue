...
function _getOverridingManualHeader(autoHeaderKey: string) {
  const manualHeaders = requestStore.currentRequest.headers;
  return manualHeaders.find(h => h.enabled && h.key.toLowerCase() === autoHeaderKey.toLowerCase());
}
        ...
        >
          ...
          <div
            ...
            :class="[
              ...
              isHeaderOverridden(header.key) ? 'opacity-40' : 'opacity-60',
            ]"
          >
            <button
              :class="[
